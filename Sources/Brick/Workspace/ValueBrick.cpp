...
void Workspace::ValueBrick::makeShadow(QPoint pos) { return; };
void Workspace::ValueBrick::removeShadow() { return; };
void Workspace::ValueBrick::replaceShadow(Brick* brick) { return; };